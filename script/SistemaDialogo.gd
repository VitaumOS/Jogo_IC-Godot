...
func _ready():
	...
	# Garante que o diálogo ignore o pause do jogo
	process_mode = PROCESS_MODE_ALWAYS

## Função principal para iniciar uma sequência de diálogo
# 'falas' deve ser um Array de Dicionários: [{"nome": "Gato", "texto": "Oi", "retrato": texture}, ...]
func iniciar_dialogo(falas: Array):
	...
	_indice_atual = 0
	visible = true
	# Opcional: Pausar o jogo enquanto o diálogo acontece
...
func _input(event):
	# Se clicar ou apertar 'ui_accept' (Enter/Espaço)
...
func _exibir_fala_atual():
	...
	# Configura o Texto e inicia efeito
...
func _iniciar_digitacao():
	...
	# Força o tween a rodar mesmo no pause
